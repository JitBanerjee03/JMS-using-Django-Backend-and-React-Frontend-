    ...
    <div style={{ marginLeft: '8%', marginRight: '8%' }}>
      <header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul className='nav nav-pills'>
          ...
          <li className='nav-item'>
            <Link to={'/post-journal'} className={`nav-link ${activeLink === 'Post Journal' ? 'active' : ''}`} onClick={() => handleLinkClick('Post Journal')}>Post Journal</Link>
          </li>
        ...
        <button type="button" class="btn btn-outline-warning" style={{marginLeft:'2%'}}
